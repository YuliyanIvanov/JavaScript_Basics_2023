function bouquetPrice(input) {
  ...
  let chrysanthemumsTotal = chrysanthemumsPrice * chrysanthemumsAmount;
  let rosesTotal = rosesPrice * rosesAmount;
  let tulipTotal = tulipsPrice * tulipsAmount;

  finalPrice = chrysanthemumsTotal + rosesTotal + tulipTotal;
...
bouquetPrice(["2", "4", "8", "Spring", "Y"]);
bouquetPrice(["3", "10", "9", "Winter", "N"]);
